...
$(document).ready(function() {
	...
	xhr2.responseType = "text";//默认为text//json
	xhr2.onreadystatechange = function(){
		if (xhr2.readyState == 4){ 
			if ((xhr2.status >= 200 && xhr2.status < 300) || xhr2.status == 304){ 
				...
				console.log("ajax请求失败,请求:querySqsydw,状态码:"+xhr2.status +",状态说明:"+ xhr2.statusText+",xhr readyState:"+xhr2.readyState);
			} 
		}
	};
	xhr2.open("post", "querySqsydw", true);
